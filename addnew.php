...
if(isset($_POST['btn-register']))
{
  ...
  $upass = md5(mysqli_real_escape_string($_POST['password']));
  ...
  if($count == 0){
    ...
    if(mysqli_query($link,"INSERT INTO user(username,email,password,country) VALUES('$uname','$email','$upass','$country')"))
    {
      ?>
...
<section class="addnew" id="about">
    ...
    <div class="row">
     <div class="col-lg-8 col-lg-offset-2">
      <form  class="form-horizontal sign-in" method="POST">		
        ...
        <div class="ui form"><div class="field"><label>Where is this culture from?</label></div></div>
        
        <div class="ui fluid multiple selection dropdown dd">
        ...
        <div class="ui form">
          ...
          <div class="field">
            <label>Say something about this culture.<br>Write for a large audience. Lots of people will read this, so give some background information.</label>
      ...
      <div class="ui form">
          ...
          <div class="field">
            <label>Is it some kind of a gesture or an etiquette that your country practice?</label>
      ...
      <select class="ui fluid selection dropdown dd" name="category1" id="category1">
        ...
        <option value="0">Gestures</option>
        <option value="1">Etiquette</option>
      </select>

      <div class="ui form">

          <div class="field">
            <label>Now, choose any that relate best with your culture.</label>
      ...
      <div class="category2" >
       <select class="ui fluid selection dropdown dd" name="category2" id="category2" >
        ...
        <option value="0">Friendly gestures</option>
        <option value="1">Gestures of respect</option>
        <option value="2">Salutes</option>
        <option value="3">Celebratory gestures</option>
        <option value="4">Finger-counting</option>
        <option value="5">Obscene gestures</option>
        <option value="6">Taunts</option>
        <option value="7">Head motions</option>
        <option value="8">Other gestures</option>
        <option value="9">Obscene gestures</option>
      </select>
    </div>
    ...
    <div class="category3" style="display:none!important;">
      <select class="ui fluid selection dropdown dd" name="category3" id="category3">
        ...
        <option value="1">Making payment</option>
        <option value="2">Visiting someone's house</option>
        <option value="3">Gifts and gift-giving</option>
        <option value="4">Table manners</option>
        <option value="5">Eating and drinking</option>
        <option value="6">Funerals</option>
        <option value="7">Bars and restaurants</option>
        <option value="8">Driving</option>
        <option value="9">Business etiquette</option>
        <option value="10">Hierarchy and honoring the elder</option>
      </select>
    </div>
...
<div class="ui form">
          ...
          <div class="field">
            <label>Upload a picture that best describe the culture.</label>
  ...
  <button class="ui blue button">
    ...
    <button class="ui fluid secondary button dd">
      SUBMIT
    </button>
