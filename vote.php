...
<section class="voting" id="about">
		...
		if(!isset($_SESSION['user']))
		{
			...
			<div class="row">
				...
				<div class="col-lg-10 col-lg-offset-1">
					<a href="sign-in.php" class="fluid huge ui button black">Add your own culture!</a>
				</div>
	...
	$query = mysqli_query($link,"select * from practices, user where practices.userID=user.userID");
  ...
  //$query = mysql_query("select * from gesture ");
				...
				<div class="col-lg-10 col-lg-offset-1">
					<a href="addnew.php" class="fluid huge ui button black">Add your own culture!</a>
				</div>
